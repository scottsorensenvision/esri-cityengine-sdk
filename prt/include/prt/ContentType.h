...
enum ContentType {
	...
	CT_CGAPRINT,		///< extension can handle CGA print events (see cga @cgaref{op_print.html,print()})
	CT_CGAREPORT,		///< extension can handle CGA report events (see cga @cgaref{op_report.html,report()})
